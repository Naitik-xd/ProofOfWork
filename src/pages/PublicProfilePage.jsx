  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-[180px] overflow-hidden bg-[#111] rounded-t-2xl">
        {profile?.show_certificate !== false ? (
          <CertificatePreview
            url={project.certificate_url}
            isImage={!isPdf}
          />
        ) : (
          <div className="w-full h-full flex flex-col items-center justify-center text-[#555] bg-[#0a0a0a]">
        ...
        {/* Badge */}
        {profile?.show_competition_name !== false && project.competition_name && (
      ...
      <div className="px-5 pb-5 flex items-center gap-2 mt-auto">
        ...
        {profile?.show_project_url !== false && project.project_url && (
          <button
